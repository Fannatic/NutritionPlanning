...
function RecipeForm(props: RecipeFormProps) {
  ...
  return (
    <div>
      <h3>Recipe Form<Button onClick={()=> {
        setEditedData(undefined)
        setRecipeFormMode("Create");
        setRecipeDataToUpdate(undefined);
      ...
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        <Row className="mb-3">
          ...
          <Form.Group as={Col} md="6">
            <Form.Label>Ingridents
              <span style={{ display: "inline-flex" }}>
                <Button disabled={!editedData} onClick={handleShow} variant="link">
                  <FaPlus />
                </Button>{' '}
              </span></Form.Label>
            <ListGroup>
          ...
          <Form.Group as={Col} md="6">
            ...
            <Form.Control as="textarea" name="steps"               onChange={(e) => handleDataChange(e)}
